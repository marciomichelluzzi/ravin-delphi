...
type
  TPROPRIEDADE = (LOGADO, LOGIN_ATUAL, DATAHORA_ULTIMO_LOGIN, SERVIDOR_BANCO, PORTA_BANCO, USUARIO_BANCO, SENHA_BANCO, NOME_BANCO, CAMINHO_BANCO,
    DRIVER_ID);
...
begin
  LcaminhoArquivoIni := TPath.Combine(TPath.Combine(TPath.GetDocumentsPath, 'ravin'), 'configuracoes.ini');
